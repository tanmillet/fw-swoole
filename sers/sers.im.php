...
//                'document_root' => "/ws/soft/app/fw-swoole/public/static",
    ...
    {
        swoole_set_process_name("im_master");
    }
    ...
    public function onOpen($ws, $request)
    {
        ...
        Libs_Predis::getInstance()->sAdd(Libs_Conf::get('im_key', 'redis'), $request->fd);
    ...
    {
        Libs_Predis::getInstance()->sRem(Libs_Conf::get('im_key', 'redis'), $fd);
